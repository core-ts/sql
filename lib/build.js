      ...
      if (v != null) {
        ...
        if (attr.version) {
          ...
          if (v === "") {
            ...
            values.push(p);
            if (v === true) {
              var v2 = attr.true !== undefined ? attr.true : true;
              args.push(v2);
            }
            else {
              var v2 = attr.false !== undefined ? attr.false : false;
              args.push(v2);
            }
          }
          else {
          ...
          if (v != null) {
            ...
            if (k === ver) {
              ...
              if (v === "") {
                ...
                values.push(p);
                if (v === true) {
                  var v2 = attr.true !== undefined ? attr.true : "1";
                  args.push(v2);
                }
                else {
                  var v2 = attr.false !== undefined ? attr.false : "0";
                  args.push(v2);
                }
              }
              else {
...
function update(exec, obj, table, attrs, buildParam, pks, ver, i) {
  var stm = buildToUpdate(obj, table, attrs, buildParam, pks, ver, i);
  if (!stm.query) {
    return Promise.resolve(0);
  }
  else {
...
function buildToUpdate(obj, table, attrs, buildParam, pks, ver, i) {
  if (!i) {
    i = 1;
  }
  var o = obj;
...
function updateBatch(exec, objs, table, attrs, buildParam, pks, ver, notSkipInvalid) {
  var stmts = buildToUpdateBatch(objs, table, attrs, buildParam, pks, ver, notSkipInvalid);
  if (stmts.length === 0) {
    return Promise.resolve(0);
  }
  else {
...
function buildToUpdateBatch(objs, table, attrs, buildParam, pks, ver, notSkipInvalid) {
  var sts = [];
  if (!pks) {
    pks = [];
    var ks = Object.keys(attrs);
  ...
  for (var _a = 0, objs_3 = objs; _a < objs_3.length; _a++) {
    var obj = objs_3[_a];
    var smt = buildToUpdate(obj, table, attrs, buildParam, pks, ver);
    if (!smt.query) {
      if (notSkipInvalid) {
        return sts;
      }
...
function buildMetadata(attrs) {
  ...
  var bools = [];
  var fields = [];
  var m = { keys: ats, fields: fields, map: mp };
