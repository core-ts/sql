...
var LogExecutor = (function () {
  ...
  LogExecutor.prototype.execute = function (sql, args) {
    var _this = this;
    var t1 = new Date();
  ...
  LogExecutor.prototype.executeBatch = function (statements, firstSuccess) {
    var _this = this;
    var t1 = new Date();
    return this.executor
  ...
  LogExecutor.prototype.query = function (sql, args, m, bools) {
    var _this = this;
    var t1 = new Date();
    return this.executor
  ...
  LogExecutor.prototype.queryOne = function (sql, args, m, bools) {
    var _this = this;
    var t1 = new Date();
    return this.executor
  ...
  LogExecutor.prototype.executeScalar = function (sql, args) {
    var _this = this;
    var t1 = new Date();
    return this.executor
  ...
  LogExecutor.prototype.count = function (sql, args) {
    var _this = this;
    var t1 = new Date();
    return this.executor
      .count(sql, args)
